...
def get_dataloaders(dataset, dataset_name, prot_model, target_scaler, seed, batch_size, world_size, rank, inference=False, pin_memory=False, num_workers=0):
    ...
    if inference:
        ...
        train_dataset = DTIDatasetPLMInference(train_drugs, train_targets, train_targets_seq, train_affinities)
    else:
        train_dataset = DTIDatasetPLM(train_drugs, train_targets, train_affinities)
    ...
    if inference:
        ...
        valid_dataset = DTIDatasetPLMInference(valid_drugs, valid_targets, valid_targets_seq, valid_affinities)
    else:
        valid_dataset = DTIDatasetPLM(valid_drugs, valid_targets, valid_affinities)
    ...
    if inference:
        ...
        test_dataset = DTIDatasetPLMInference(test_drugs, test_targets, test_targets_seq, test_affinities)
    else:
        test_dataset = DTIDatasetPLM(test_drugs, test_targets, test_affinities)
