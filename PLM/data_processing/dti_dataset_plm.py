...
class DTIDatasetPLM(Dataset):
    def __init__(self, drugs, prot_embeds, affinities):
        """
        Args:
    ...
    def __getitem__(self, idx):
        ...
        return mol_graph, prot_embedding, label


class DTIDatasetPLMInference(Dataset):
    def __init__(self, drugs, prot_embeds, targets_seq, affinities):
        """
        Args:
            drugs (list): List of SMILES strings
            prot_embeds (list): List of protein embeddings
    ...
    def __getitem__(self, idx):
        ...
        label = self.affinities[idx]
        return mol_graph, prot_embedding, targets_sequence, label